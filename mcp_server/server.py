...
@mcp.tool()
def run_black_scholes(S: float, K: float, T: float, r: float, sigma: float, option_type: str = "call"):
    """
...
@mcp.tool()
def run_monte_carlo(S: float, K: float, T: float, r: float, sigma: float, option_type: str = "call", num_simulations: int = 10000):
    """
